...
`;var y=i("5Doro"),b=i("a8kcR"),x=i("h5kyv"),w=i("8DCD7"),E=i("8o1bQ"),O=i("bcqzL");const N=t(o).lazy((()=>i("3A1ut")));c.fileLogger.init({provider:E.ProxyFileLoggerProvider}),c.telemetry.init(),c.telemetry.setUser({id:x.analytics.getDeviceId()}),(0,w.initializeFeatureFlags)();const F=document.getElementById("root");(0,u.createRoot)(F).render(t(o).createElement(l.BrowserRouter,null,t(o).createElement(s.ThemeProvider,{theme:b.theme},t(o).createElement(y.QueryProvider,null,t(o).createElement(O.ThemedGlobalStyle,{backgroundColor:"#E2DFFE"}),t(o).createElement((()=>{const{t:e}=(0,f.useTranslation)();return t(o).createElement(m,null,t(o).createElement(P,{href:g.PHANTOM_WEBSITE_URL,target:"_blank",rel:"noopener noreferrer"},t(o).createElement(p.IconPhantomLogo,{width:32})),t(o).createElement(v,{"data-testid":"full-page-header-support-link",href:g.PHANTOM_SUPPORT_URL,rel:"noopener",target:"_blank"},t(o).createElement(p.IconHelp,null),t(o).createElement(h.Text,{color:"#222222",size:16,weight:500,margin:"0 0 0 8px"},e("fullPageHeaderHelp"))))}),null),t(o).createElement(d.OnboardingAndConnectHardwareErrorBoundary,null,t(o).createElement(o.Suspense,{fallback:null},t(o).createElement(N,null))))))),x.analytics.capture("connectHardwareOpen");
